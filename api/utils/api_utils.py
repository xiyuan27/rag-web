...
def server_error_response(e):
    # 记录详细异常信息到error.log
    log_detailed_exception(e, context={"function": "server_error_response"})
    ...
    # 返回用户友好错误
    return create_user_friendly_error(e)
...
def construct_error_response(e):
    # 记录详细异常信息
    log_detailed_exception(e, context={"function": "construct_error_response"})
