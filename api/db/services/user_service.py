...
class UserTenantService(CommonService):
    ...
    def get_tenants_by_user_id(cls, user_id):
        ...
        return list(cls.model.select(*fields)
                    .join(User, on=((cls.model.tenant_id == User.id) & (UserTenant.user_id == user_id) & (
    ...
    def get_num_members(cls, tenant_id: str):
        cnt_members = cls.model.select(peewee.fn.COUNT(cls.model.id)).where(cls.model.tenant_id == tenant_id).scalar()
        return cnt_members
